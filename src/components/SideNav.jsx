    ...
    <ul class='hidden xl:block xl:fixed' style='top:30%; z-index:1000;'>
      ...
      <li class='ml-4 mb-3'>
        ...
        <li class='ml-4 mb-3'>
          ...
          >
            <span class="inline-block p-1 bg-white border-2 border-gray-400 rounded-full align-middle mr-2" style="margin-bottom:5px;">
              <img src={ShirtIcon} style="height:18px; width:18px;" alt="bell icon"/>
            </span>
        ...
        <li class='ml-4 mb-3'>
          ...
          >
            <span class="inline-block p-1 bg-white border-2 border-gray-400 rounded-full align-middle mr-2" style="margin-bottom:5px;">
              <img src={dressIcon} style="height:18px; width:18px;" alt="bell icon"/>
            </span>
        ...
        <li class='ml-4 mb-3'>
          ...
          >
            <span class="inline-block p-1 bg-white border-2 border-gray-400 rounded-full align-middle mr-2" style="margin-bottom:5px;">
              <img src={JeansIcon} style="height:18px; width:18px;" alt="bell icon"/>
            </span>
        ...
        <li class='ml-4 mb-3'>
          ...
          >
            <span class="inline-block p-1 bg-white border-2 border-gray-400 rounded-full align-middle mr-2" style="margin-bottom:5px;">
              <img src={coatIcon} style="height:18px; width:18px;" alt="bell icon"/>
            </span>
